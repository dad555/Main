...
public class BeatBox implements Serializable {
    private static final long serialVersionUID = -3776608995617649232L;
    ...
    public void buildGUI() {
        ...
        clearBoxes.addActionListener(new MyClearBoxButton());
    ...
    public class MyClearBoxButton implements ActionListener {
    ...
    public class MySendListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                ObjectOutputStream os = new ObjectOutputStream(new FileOutputStream(saveFile.getSelectedFile()));
